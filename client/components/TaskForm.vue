<template>
  ...
  <transition name="fade">
    ...
    <div v-if="visible" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      ...
      <div class="bg-gray-800 rounded-lg w-full max-w-lg p-6 relative">
        ...
        <form @submit.prevent="onSubmit">
          ...
          <input
            ...
            :class="['w-full bg-gray-700 p-2 rounded mb-3 focus:outline-none focus:ring-2',
              nameError
                ? 'border border-red-500'
                : 'border border-gray-600 focus:ring-sky-600'
            ]"/>
          ...
          <input
            ...
            class="w-full bg-gray-700 border border-gray-600 p-2 rounded mb-3 focus:outline-none focus:ring-2 focus:ring-sky-600"/>
          ...
          <input
            ...
            type="text"
            placeholder="Tags"
            class="w-full bg-gray-700 border border-gray-600 p-2 rounded mb-4 focus:outline-none focus:ring-2 focus:ring-sky-600"/>
          ...
          <div class="flex justify-end gap-2">
            ...
            <button
              type="submit"
              class="px-4 py-2 bg-sky-600 hover:bg-sky-300 rounded">
